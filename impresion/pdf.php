...
class PPDF extends FPDF
{
	...
	{
		global $idioma;
		$this->SetTitle(utf8Decode("Reporte"), true);
		$this->SetAuthor(utf8Decode("Sistema de Registro Antecedentes Vehiculares de la Policia Boliviana por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"), true);
		$this->SetSubject(utf8Decode("Sistema de Registro Antecedentes Vehiculares de la Policia Boliviana por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"), true);
		$this->SetCreator(utf8Decode("Sistema de Registro Antecedentes Vehiculares de la Policia Boliviana  Desarrollado por Ronald Nina Layme. Cel: 73230568 - www.facebook.com/ronaldnina"), true);
		...
		$this->ln(5);
		$this->CuadroCabecera(40, "Fecha del Reporte:", 20, utf8Encode($fecha));
		$this->ln(5);
	...
	function CuadroNombre($txtAncho, $Paterno, $Materno, $Nombres, $Full = 0, $relleno = 0)
	{
		if ($Full) {
	...
	function Footer()
	{
		...
		$this->Fuente("I", 7.5);
		$this->Cell($this->ancho, 0, "", 1, 1);
		$this->Cell(50, 4, utf8Decode("Reporte Generado") . ": " . date('d-m-Y H:i:s'), 0, 0, "L");
		$this->Fuente("I", 8);
		$this->Cell((round(($this->ancho - 50) / 2) - 10), 4, utf8Decode($lema), 0, 0, "C");
		$this->Fuente("I", 7);
		...
		if ($this->CurOrientation == "P") {
			...
			$this->Cell((round(($this->ancho - 50) / 2) + 10), 4, utf8Decode(" "), 0, 0, "R");
		}
