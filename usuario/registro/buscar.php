...
$usuario=new usuario;
$su=$usuario->mostrarTodoRegistro("NivelAcceso!=1  and NivelAcceso LIKE '$NivelAcceso' and Nombres LIKE '%$Nombres%' and Apellidos LIKE '%$Apellidos%' and Ci LIKE '%$Ci%'",1,"Apellidos,Nombres",1);
//print_r($di);
        	...
        	<tr>
				...
				<td class="small">
					<table class="table table-bordered">
						...
						<tr>
							<td class="der resaltar" width="30%">Nivel Acceso: </td>
