...
$su = $vehiculo->mostrarTodoRegistro("CodMarca LIKE '$CodMarca' and CodServicioTransporte LIKE '$CodServicioTransporte'  and Placa LIKE '%$Placa%' and CodChofer IN (SELECT CodChofer FROM chofer WHERE Ci LIKE '%$Ci%')", 1, "Placa", 1);
//print_r($di);
	...
	<tbody>
		...
		?>
			<tr>
				...
				?>
					<td class="text-center">
						<a href="eliminar.php?Cod=<?php echo $d['CodVehiculo'] ?>" class="btn btn-danger btn-xs eliminarDatos" title="Eliminar" rel="<?php echo $d['CodVehiculo'] ?>">
