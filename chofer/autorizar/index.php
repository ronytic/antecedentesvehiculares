...
$titulo="Autorizar Modificación de Taxista/Choferes";
$folder="../../";
...
$(document).ready(function(){
	...
	$("#formulario").submit(function(e) {
		...
		var Ci=$("[name=Ci]").val();
		$.post("buscar.php",{CodCategoria:CodCategoria,CodServicioTransporte:CodServicioTransporte,CodRuta:CodRuta,Nombres:Nombres,Paterno:Paterno,Materno:Materno,Ci:Ci},function(data){
			$("#respuesta").html(data);
		});
	})
	.submit();
